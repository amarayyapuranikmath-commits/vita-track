...
export default function Topbar({ onToggleSidebar }) {
    ...
    return (
        <header
            className="h-16 bg-white border-b border-[#E5E7EB] flex items-center justify-between px-4 md:px-6 flex-shrink-0"
        ...
        >
            ...
            <div className="flex items-center gap-2.5 w-full md:w-auto">
                <button
                    ...
                    className="lg:hidden p-2 rounded-xl text-[#6B7280] hover:bg-gray-50 hover:text-[#111827] transition flex-shrink-0"
                >
